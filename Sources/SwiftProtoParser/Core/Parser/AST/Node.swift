...
public extension DefinitionNode {
    /// The fully qualified name of this definition, including package name
    func fullName(inPackage package: String?) -> String {
...
public extension DefinitionContainer {
    /// Returns all nested definitions recursively
    var allNestedDefinitions: [DefinitionNode] {
