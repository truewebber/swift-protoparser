...
public final class Lexer {
    ...
    private func tokenizeNumber() throws {
        ...
        if !isAtEnd() && currentCharacter().isWholeNumber {
            ...
            // Sign without digits
            throw LexerError.invalidIntegerLiteral(String(input[startIndex..<currentIndex]), line: startLine, column: startColumn)
        }
        ...
        if !isAtEnd() && (currentCharacter() == "e" || currentCharacter() == "E") {
            ...
            if isAtEnd() || !currentCharacter().isWholeNumber {
                throw LexerError.invalidFloatLiteral(String(input[startIndex..<currentIndex]), line: startLine, column: startColumn)
            }
