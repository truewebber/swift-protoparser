...
struct ParserState {
  ...
  @discardableResult
  mutating func advanceIf(_ predicate: (Token) -> Bool) -> Token? {
  ...
  @discardableResult
  mutating func advanceIf(_ tokenType: TokenType) -> Token? {
    return advanceIf { $0.type == tokenType }
  }

  /// Advances to the next token if it's a keyword with the given value.
  @discardableResult
  mutating func advanceIfKeyword(_ keyword: ProtoKeyword) -> Token? {
    return advanceIf {
  ...
  @discardableResult
  mutating func advanceIfIdentifier() -> Token? {
    return advanceIf {
  ...
  @discardableResult
  mutating func advanceIfSymbol(_ symbol: String) -> Token? {
    return advanceIf {
  ...
  @discardableResult
  mutating func expect(_ tokenType: TokenType, expected: String) -> Token? {
  ...
  @discardableResult
  mutating func expectKeyword(_ keyword: ProtoKeyword) -> Token? {
  ...
  @discardableResult
  mutating func expectSymbol(_ symbol: String) -> Token? {
  ...
  func checkKeyword(_ keyword: ProtoKeyword) -> Bool {
  ...
  func checkSymbol(_ symbol: String) -> Bool {
    if let token = currentToken,
  ...
  mutating func addError(_ error: ParserError) {
    errors.append(error)
  }
