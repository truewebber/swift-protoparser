...
public struct ParserState {
    ...
    public var stringLiteralValue: String? {
        guard let token = currentToken,
              case .stringLiteral(let value) = token.type else {
            return nil
        }
        return value
    }
    ...
    public var integerLiteralValue: Int64? {
        guard let token = currentToken,
              case .integerLiteral(let value) = token.type else {
            return nil
        }
        return value
    }
    ...
    public var floatLiteralValue: Double? {
        guard let token = currentToken,
              case .floatLiteral(let value) = token.type else {
            return nil
        }
        return value
    }
    ...
    public var booleanLiteralValue: Bool? {
        guard let token = currentToken,
              case .boolLiteral(let value) = token.type else {
            return nil
        }
        return value
    }
