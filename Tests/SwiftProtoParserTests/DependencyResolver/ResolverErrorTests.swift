...
final class ResolverErrorTests: XCTestCase {
  ...
  func testCircularDependencyError() {
    ...
    XCTAssertEqual(
      ...
      "Circular dependency detected: file1.proto → file2.proto → file3.proto → file1.proto"
    )
  ...
  func testDuplicateFileError() {
    ...
    XCTAssertEqual(
      error.errorDescription,
      "Duplicate file 'file.proto' found at: /path1/file.proto, /path2/file.proto, /path3/file.proto"
    )
    XCTAssertNil(error.failureReason)
    XCTAssertNil(error.recoverySuggestion)
  }
