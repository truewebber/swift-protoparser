...
final class PerformanceCacheComprehensiveTests: XCTestCase {
  ...
  func testDescriptorCacheInvalidation() throws {
    ...
    // Cache with old hash
    cache.cacheDescriptor(descriptor, for: filePath, contentHash: oldContentHash, fileSize: fileSize, buildTime: buildTime)
  ...
  func testDescriptorCacheEviction() throws {
    ...
    smallCache.cacheDescriptor(descriptor, for: "/test/desc1.proto", contentHash: "hash1", fileSize: fileSize, buildTime: buildTime)
    smallCache.cacheDescriptor(descriptor, for: "/test/desc2.proto", contentHash: "hash2", fileSize: fileSize, buildTime: buildTime)
    smallCache.cacheDescriptor(descriptor, for: "/test/desc3.proto", contentHash: "hash3", fileSize: fileSize, buildTime: buildTime)
  ...
  func testCombinedHash() throws {
    let file1 = try createTestResolvedProtoFile(path: "/test/file1.proto", content: "syntax = \"proto3\"; message Test1 {}")
    let file2 = try createTestResolvedProtoFile(path: "/test/file2.proto", content: "syntax = \"proto3\"; message Test2 {}")
    let file3 = try createTestResolvedProtoFile(path: "/test/file3.proto", content: "syntax = \"proto3\"; message Test3 {}")
  ...
  func testAverageBuildTimeCalculation() throws {
    ...
    cache.cacheDescriptor(descriptor, for: "\(filePath)1", contentHash: "\(contentHash)1", fileSize: fileSize, buildTime: 0.05)
    cache.cacheDescriptor(descriptor, for: "\(filePath)2", contentHash: "\(contentHash)2", fileSize: fileSize, buildTime: 0.10)
    cache.cacheDescriptor(descriptor, for: "\(filePath)3", contentHash: "\(contentHash)3", fileSize: fileSize, buildTime: 0.15)
