...
final class SourceInfoGeneratorTests: XCTestCase {
    ...
    private func createFieldNode(name: String, number: Int, type: TypeNode, line: Int, column: Int) -> FieldNode {
        return FieldNode(
            location: SourceLocation(line: line, column: column),
            name: name,
            type: type,
    ...
    func testGenerateSourceInfoForEmptyFile() {
        ...
        // Assert
        XCTAssertFalse(sourceInfo.location.isEmpty, "Source info should contain at least the file location")
    }
    ...
    func testGenerateSourceInfoForFileWithPackage() {
        ...
        // Assert
        XCTAssertTrue(sourceInfo.location.contains { location in
