...
class MapFieldIssueReproductionTest: XCTestCase {
  ...
  func testMapFieldDescriptorGeneration() throws {
    ...
    // 1. Type = TYPE_MESSAGE
    XCTAssertEqual(metadataField.type, Google_Protobuf_FieldDescriptorProto.TypeEnum.message, "Map field should be TYPE_MESSAGE")
    
    // 2. Label = LABEL_REPEATED
    XCTAssertEqual(metadataField.label, Google_Protobuf_FieldDescriptorProto.Label.repeated, "Map field should be LABEL_REPEATED")
