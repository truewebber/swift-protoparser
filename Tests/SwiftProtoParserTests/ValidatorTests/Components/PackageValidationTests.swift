...
final class PackageValidationTests: XCTestCase {
    ...
    func testValidPackageNames() throws {
        ...
        for packageName in validPackages {
            ...
            XCTAssertNoThrow(try validator.validate(file), "Package name '\(packageName)' should be valid")
        }
    }
    ...
    func testInvalidPackageNames() throws {
        ...
        for packageName in invalidPackages {
            ...
            XCTAssertThrowsError(try validator.validate(file), "Package name '\(packageName)' should be invalid") { error in
