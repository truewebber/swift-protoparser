...
final class FieldTypeValidationTests: XCTestCase {
    ...
    func testInvalidMapKeyTypes() throws {
        ...
        for keyType in invalidKeyTypes {
            ...
            XCTAssertThrowsError(try fieldValidator.validateMapKeyType(keyType), "Map key type \(keyType) should be invalid") { error in
        ...
        // This should throw an invalidMapKeyType error
        XCTAssertThrowsError(try fieldValidator.validateField(field, inMessage: messageNode), "Map key type bytes should be invalid") { error in
            guard let validationError = error as? ValidationError else {
    ...
    func testValidMapValueTypes() throws {
        ...
        // This should not throw
        XCTAssertNoThrow(try validator.validate(fileWithMessageValueType), "Message type as map value should be valid")
    }
    ...
    func testMapFieldModifiers() throws {
        ...
        XCTAssertThrowsError(try fieldValidator.validateField(repeatedMapField, inMessage: messageNode), "Repeated map field should be invalid") { error in
            guard let validationError = error as? ValidationError else {
        ...
        XCTAssertThrowsError(try fieldValidator.validateField(optionalMapField, inMessage: messageNode), "Optional map field should be invalid") { error in
            guard let validationError = error as? ValidationError else {
    ...
    func testRepeatedFields() throws {
        ...
        for scalarType in scalarTypes {
            ...
            // This should not throw
            XCTAssertNoThrow(try validator.validate(file), "Repeated scalar field of type \(scalarType) should be valid")
        }
        ...
        XCTAssertNoThrow(try fieldValidator.validateField(field, inMessage: messageNode), "Repeated message field should be valid")
        
        // Verify that the mock reference validator doesn't throw
        XCTAssertNoThrow(try mockReferenceValidator.validateTypeReference("OtherMessage", inMessage: messageNode), "Mock reference validator should not throw")
    }
    ...
    func testOptionalFields() throws {
        ...
        for scalarType in scalarTypes {
            ...
            // This should not throw
            XCTAssertNoThrow(try validator.validate(file), "Optional scalar field of type \(scalarType) should be valid")
        }
        ...
        // This should not throw when using our mock validator
        XCTAssertNoThrow(try fieldValidator.validateField(field, inMessage: messageNode), "Optional message field should be valid")
